...
router.post("/", message_controller.delete_post)
...
/// ------------------------------ CREATE A MESSAGE ------------------------------ ///
router.get("/create-message", message_controller.create_get);
router.post("/create-message", message_controller.create_post);
